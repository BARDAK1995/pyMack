"""Ozgen & Kircali 2D temporal shoot-search utilities.

This module follows the first six equations of Ozgen & Kircali (2008),
Eqs. 22-28, for two-dimensional disturbances over a two-dimensional mean flow.
It is intentionally separate from the Mack Appendix-A shooter because Ozgen's
printed first-order system uses its own variable set and Stokes-hypothesis
