...
\end{equation}
where $a_e$ is the edge speed of sound and $R_g$ the specific gas constant.
...
\begin{figure}[h]\centering
  ...
  generalised inflection point, the seat of the inviscid instability (discussed in the companion notes on
  the instability mechanisms).}\label{fig:baseflow}
\end{figure}
