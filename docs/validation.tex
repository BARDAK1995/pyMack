...
At the case-4 conditions the temporal GEVP is read for its eigen\emph{vector} rather than its
eigenvalue: from a real wavenumber $\alpha$ it returns the discrete eigenpair, of which the
temperature component $\hat T(y)$ is compared. This is therefore a mode-shape check, not an
